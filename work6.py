...
# box_3 = tk.Button(window, text=" ")
# box_3.pack(side=tk.LEFT, anchor=tk.N)
# box_4 = tk.Button(window, text=" ")
# box_4.pack(side=tk.LEFT, anchor=tk.N)
# box_5 = tk.Button(window, text=" ")
# box_5.pack(side=tk.LEFT, anchor=tk.N)

# box_6 = tk.Button(window, text=" ")
# box_6.pack(side=tk.LEFT, anchor=tk.N)
# box_7 = tk.Button(window, text=" ")
# box_7.pack(side=tk.LEFT, anchor=tk.N)
# box_8 = tk.Button(window, text=" ")
# box_8.pack(side=tk.LEFT, anchor=tk.N)
